...
from WebDiscussPython import WebDiscussPython
...
web7 = WebDiscussPython(global_scheduler, main_logger, browser)
web7.set_schedule( "10:15", "22:40", 2 )
...
web6.set_schedule( "09:15", "20:00", 10 )
